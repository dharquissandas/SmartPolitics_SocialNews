...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <hr>
            <p class="lead">Email Account: <?php echo $_SESSION['email']; ?> </p>
        </div>
    </div>

    <div class="container">
    <button onclick="location.href='accountallposts.php'" type="button" class="btn btn-primary mb-2">All Posts</button>
        <button onclick="location.href='accountownposts.php'"  type="button" class="btn btn-primary mb-2">My Posts</button>
        <button onclick="location.href='accountcomments.php'"  type="button" class="btn btn-primary mb-2">Comments</button>
        <button onclick="location.href='accountlikes.php'"  type="button" class="btn btn-primary mb-2" disabled>Likes</button>
        <h1 class="my-4">Likes</h1>
        <div class="row">
            <div class="col-md-8">
                <?php
                    $userid = $_SESSION['id'];
                    $query =  "SELECT ID, title, topic, post, timestamp, upvotes, userid FROM entries WHERE userid  ='$userid'";
