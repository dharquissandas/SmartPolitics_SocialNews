...
<body>
    ...
    <div class="container">
        ...
        <button onclick="location.href='accountownposts.php'"  type="button" class="btn btn-primary mb-2" disabled>My Posts</button>
        <button onclick="location.href='accountcomments.php'"  type="button" class="btn btn-primary mb-2">Comments</button>
        <button onclick="location.href='accountlikes.php'"  type="button" class="btn btn-primary mb-2">Likes</button>
