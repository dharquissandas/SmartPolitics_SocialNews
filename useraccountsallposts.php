...
<body>
    ...
    <div class="container">
        <button onclick="location.href='useraccountsallposts.php?id=<?php echo $id; ?>'" type="button" class="btn btn-primary mb-2" disabled>All Posts</button>
        ...
        <button onclick="location.href='useraccountslikes.php?id=<?php echo $id; ?>'"  type="button" class="btn btn-primary mb-2">Likes</button>
