    ...
    <body>
        ...
        <div class="jumbotron py-4">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="display-4">Timeline (NOT DONE)</h1>
                        <p class="lead">Should have posts of everyone that is followed etc</p>
                        <div class="btn-group">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php
                        ...
                        $query = 'SELECT ID, title, topic, post, timestamp, upvotes, userid FROM entries WHERE userid ORDER BY ID DESC';
