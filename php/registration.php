    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div id="errorjumbo" class="jumbotron">
                    ...
                    <p class="lead">The Email is already in use</p>
                    <hr class="my-4">
                    <p>If you have an account already try logging in, if not try to register again using another email address. The options are present in the navigation bar.</p>
                </div>        
            </div>
